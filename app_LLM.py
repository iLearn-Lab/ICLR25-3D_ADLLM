    ...
    while True:
        ...
        with gr.Blocks() as demo:
            ...
            with gr.Row():
                ...
                with gr.Column():
                    chatbot = gr.Chatbot(
                        [], elem_id="chatbot", height=560
                    )  # ,color_map=("green", "pink")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--data_path",
        type=str,
        default="/workspace/project/Aff_LLM_debug/demo/demo_data",
        required=False,
    )
    ...
    parser.add_argument(
        ...
        default="/workspace/project/Aff_LLM_debug/outputs/dgcnn_llm/3d_aff/train_dgcnn_batch_4_lr_3e-4_iteration_5000_seed_1_epoch_10_only_affdecoder/checkpoint_best.pth",
    )
