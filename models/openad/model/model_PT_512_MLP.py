...
from .PointTransformer.pointnet_util import PointNetFeaturePropagation, PointNetSetAbstraction
...
class PointTransformerSeg_512MLP(nn.Module):
    def __init__(self, cfg ,train_seg=True):
        super().__init__()
    ...
    def forward(self, x):
        x = x.permute(0,2,1)
        points, xyz_and_feats = self.backbone(x)#(b)16*8*512,
        ...
        for i in range(self.nblocks):
            ...
            points = self.transformers[i](xyz, points)[0] #points的特征16*2048*32       
